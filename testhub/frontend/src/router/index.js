  ...
  // APP自动化测试路由
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/app-automation/Index.vue')
      },
      {
        path: 'dashboard',
      ...
      {
        path: 'recorder',
        name: 'AppTestCaseRecorder',
        component: () => import('@/views/app-automation/recorder/TestCaseRecorder.vue')
      },
      {
        path: 'suites',
      ...
      },
      {
        ...
        component: () => import('@/views/app-automation/notifications/NotificationConfig.vue')
      },
      {
        path: 'environments',
        name: 'AppEnvironmentConfig',
        component: () => import('@/views/app-automation/environments/EnvironmentConfig.vue')
      }
    ]
  }
]
